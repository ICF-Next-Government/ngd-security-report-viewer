...
<body class="antialiased">
  ...
  <div id="main-content" class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800">
    <!-- Report header -->
    <header role="banner" class="bg-slate-900/50 backdrop-blur-sm border-b border-slate-800">
    ...
    <section aria-labelledby="summary-heading" class="max-w-7xl mx-auto px-6 py-10">
    ...
    <!-- Findings section -->
    <main role="main" aria-labelledby="findings-heading" class="max-w-7xl mx-auto px-6 pb-16">
      <h2 id="findings-heading" class="sr-only">Security Findings</h2>
      ${findingsSection}
    </main>

    <!-- Footer -->
    <footer role="contentinfo" class="bg-slate-900/50 backdrop-blur-sm border-t border-slate-800 mt-20">
      <div class="max-w-7xl mx-auto px-6 py-10">
        <div class="text-center text-sm text-slate-400 space-y-3">
        <p>
          Generated by
