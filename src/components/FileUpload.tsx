    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-4">
          <div
            className={`p-4 rounded-full ${dragActive ? "bg-blue-500/20" : "bg-slate-700/50"} transition-colors`}
          >
            {loading ? (
      ...
      {error && (
        <div className="mt-4 p-2 bg-red-900/50 border border-red-700 rounded-lg flex items-start space-x-3 backdrop-blur-sm">
